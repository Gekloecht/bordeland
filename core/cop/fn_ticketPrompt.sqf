...
[] spawn
{
	...
	{
		[[0,format["%1 refuse de payer l'amende.",name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
		[[1,format["%1 refuse de payer l'amende.",name player]],"life_fnc_broadcast",life_ticket_cop,false] spawn life_fnc_MP;
	};
};