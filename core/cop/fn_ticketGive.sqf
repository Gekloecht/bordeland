...
_val = ctrlText 2652;
if(!([_val] call fnc_isnumber)) exitWith {hint "Vous n'avez pas saisi le bon format."};
if((parseNumber _val) > 100000) exitWith {hint "Les amendes ne peuvent pas depasser €100,000!"};
