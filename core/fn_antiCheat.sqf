...
[] spawn {
	while {true} do {
		...
		[[format["%1 UTILISE UN CHEAT, MERCI DE LE DIRE A UN ADMIN.",name player],player],"life_fnc_displayHint",nil,false] spawn BIS_fnc_MP;
...
[] spawn {
	...
	[[format["%1 UTILISE UN CHEAT ANTI RECULE, MERCI DE LE DIRE A UN ADMIN.",name player],player],"life_fnc_displayHint",nil,false] spawn BIS_fnc_MP;
